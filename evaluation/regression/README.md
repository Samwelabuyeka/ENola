# Caren - Regression Test Framework

Caren project is an open-source software engineering AI that can solve various software engineering tasks. This repository contains the regression test framework for Caren project.

## Running the Tests

To run the tests for Caren project, you can use the provided test runner script. Follow these steps:
...
The test cases for Caren project are organized in the `cases/` directory. Each test case has the following structure:
...
- `outputs/`: This directory contains the output generated by Caren for each agent.
- `outputs/*/workspace/`: This directory contains the actual output files generated by Caren.
- `test_*.py`: These are the test scripts that validate the output of Caren.
...
- `run_test_case`: A fixture that runs Caren and generates the workspace for the current test case.
